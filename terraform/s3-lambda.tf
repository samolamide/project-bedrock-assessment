data "archive_file" "lambda_zip" {
  type        = "zip"
  source_file = "${path.module}/../lambda/bedrock-asset-processor/handler.py"
  output_path = "${path.module}/../lambda/bedrock-asset-processor/handler.zip"
}
...
resource "aws_iam_role" "lambda_asset_processor" {
  name = "project-bedrock-asset-processor"
